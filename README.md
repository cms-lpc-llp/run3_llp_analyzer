...
Note: for certain commands on LPC, (like eos, etc) you man need to install openSSL (at least to use this CMSSW for el9. See _set_SSL_vars.sh_ for installation and setting enviroment variables)
