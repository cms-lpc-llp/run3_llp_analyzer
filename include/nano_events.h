...
// Mon May  6 08:14:59 2024 by ROOT version 6.14/09
// from TTree Events/Events
// found on file:
// root://cmsxrootd.fnal.gov//store/data/Run2022E/JetMET/NANOAOD/22Sep2023-v1/30000/1c50d190-5161-4783-9870-71dd70d3beff.root
//////////////////////////////////////////////////////////

#ifndef nano_events_h
#define nano_events_h
...
public:
  ...
  Int_t nCorrT1METJet;
  Float_t CorrT1METJet_area[47];            //[nCorrT1METJet]
  Float_t CorrT1METJet_eta[47];             //[nCorrT1METJet]
  Float_t CorrT1METJet_muonSubtrFactor[47]; //[nCorrT1METJet]
  Float_t CorrT1METJet_phi[47];             //[nCorrT1METJet]
  Float_t CorrT1METJet_rawPt[47];           //[nCorrT1METJet]
  ...
  Int_t nElectron;
  Char_t Electron_seediEtaOriX[8];              //[nElectron]
  ...
  Bool_t Electron_mvaNoIso_WP80[8];             //[nElectron]
  Bool_t Electron_mvaNoIso_WP90[8];             //[nElectron]
  UChar_t Electron_seedGain[8];                 //[nElectron]
  UChar_t Electron_tightCharge[8];              //[nElectron]
  Short_t Electron_jetIdx[8];                   //[nElectron]
  Short_t Electron_photonIdx[8];                //[nElectron]
  Short_t Electron_svIdx[8];                    //[nElectron]
  Short_t Electron_fsrPhotonIdx[8];             //[nElectron]
  Int_t Electron_charge[8];                     //[nElectron]
  Int_t Electron_pdgId[8];                      //[nElectron]
  Int_t Electron_seediPhiOriY[8];               //[nElectron]
  ...
  Float_t Electron_mvaHZZIso[8];                //[nElectron]
  Float_t Electron_mvaIso[8];                   //[nElectron]
  Float_t Electron_mvaNoIso[8];                 //[nElectron]
  ...
  Int_t nFatJet;
  UChar_t FatJet_jetId[8];                        //[nFatJet]
  UChar_t FatJet_nConstituents[8];                //[nFatJet]
  Short_t FatJet_subJetIdx1[8];                   //[nFatJet]
  Short_t FatJet_subJetIdx2[8];                   //[nFatJet]
  Short_t FatJet_electronIdx3SJ[8];               //[nFatJet]
  Short_t FatJet_muonIdx3SJ[8];                   //[nFatJet]
  Float_t FatJet_area[8];                         //[nFatJet]
  Float_t FatJet_btagDDBvLV2[8];                  //[nFatJet]
  Float_t FatJet_btagDDCvBV2[8];                  //[nFatJet]
  Float_t FatJet_btagDDCvLV2[8];                  //[nFatJet]
  ...
  Float_t FatJet_particleNetWithMass_H4qvsQCD[8]; //[nFatJet]
  Float_t FatJet_particleNetWithMass_HbbvsQCD[8]; //[nFatJet]
  Float_t FatJet_particleNetWithMass_HccvsQCD[8]; //[nFatJet]
  Float_t FatJet_particleNetWithMass_QCD[8];      //[nFatJet]
  Float_t FatJet_particleNetWithMass_TvsQCD[8];   //[nFatJet]
  Float_t FatJet_particleNetWithMass_WvsQCD[8];   //[nFatJet]
  Float_t FatJet_particleNetWithMass_ZvsQCD[8];   //[nFatJet]
  Float_t FatJet_particleNet_QCD[8];              //[nFatJet]
  Float_t FatJet_particleNet_QCD0HF[8];           //[nFatJet]
  Float_t FatJet_particleNet_QCD1HF[8];           //[nFatJet]
  Float_t FatJet_particleNet_QCD2HF[8];           //[nFatJet]
  Float_t FatJet_particleNet_XbbVsQCD[8];         //[nFatJet]
  Float_t FatJet_particleNet_XccVsQCD[8];         //[nFatJet]
  Float_t FatJet_particleNet_XggVsQCD[8];         //[nFatJet]
  Float_t FatJet_particleNet_XqqVsQCD[8];         //[nFatJet]
  Float_t FatJet_particleNet_XteVsQCD[8];         //[nFatJet]
  Float_t FatJet_particleNet_XtmVsQCD[8];         //[nFatJet]
  Float_t FatJet_particleNet_XttVsQCD[8];         //[nFatJet]
  Float_t FatJet_particleNet_massCorr[8];         //[nFatJet]
  ...
  Short_t IsoTrack_charge[14];           //[nIsoTrack]
  Short_t IsoTrack_fromPV[14];           //[nIsoTrack]
  ...
  Int_t nJet;
  UChar_t Jet_jetId[64];                    //[nJet]
  UChar_t Jet_nConstituents[64];            //[nJet]
  UChar_t Jet_nElectrons[64];               //[nJet]
  UChar_t Jet_nMuons[64];                   //[nJet]
  UChar_t Jet_nSVs[64];                     //[nJet]
  Short_t Jet_electronIdx1[64];             //[nJet]
  Short_t Jet_electronIdx2[64];             //[nJet]
  Short_t Jet_muonIdx1[64];                 //[nJet]
  Short_t Jet_muonIdx2[64];                 //[nJet]
  Short_t Jet_svIdx1[64];                   //[nJet]
  Short_t Jet_svIdx2[64];                   //[nJet]
  Int_t Jet_hfadjacentEtaStripsSize[64];    //[nJet]
  Int_t Jet_hfcentralEtaStripSize[64];      //[nJet]
  Float_t Jet_PNetRegPtRawCorr[64];         //[nJet]
  Float_t Jet_PNetRegPtRawCorrNeutrino[64]; //[nJet]
  Float_t Jet_PNetRegPtRawRes[64];          //[nJet]
  Float_t Jet_area[64];                     //[nJet]
  Float_t Jet_btagDeepFlavB[64];            //[nJet]
  Float_t Jet_btagDeepFlavCvB[64];          //[nJet]
  Float_t Jet_btagDeepFlavCvL[64];          //[nJet]
  Float_t Jet_btagDeepFlavQG[64];           //[nJet]
  Float_t Jet_btagPNetB[64];                //[nJet]
  Float_t Jet_btagPNetCvB[64];              //[nJet]
  Float_t Jet_btagPNetCvL[64];              //[nJet]
  Float_t Jet_btagPNetQvG[64];              //[nJet]
  Float_t Jet_btagPNetTauVJet[64];          //[nJet]
  Float_t Jet_btagRobustParTAK4B[64];       //[nJet]
  Float_t Jet_btagRobustParTAK4CvB[64];     //[nJet]
  Float_t Jet_btagRobustParTAK4CvL[64];     //[nJet]
  Float_t Jet_btagRobustParTAK4QG[64];      //[nJet]
  Float_t Jet_chEmEF[64];                   //[nJet]
  Float_t Jet_chHEF[64];                    //[nJet]
  Float_t Jet_eta[64];                      //[nJet]
  Float_t Jet_hfsigmaEtaEta[64];            //[nJet]
  Float_t Jet_hfsigmaPhiPhi[64];            //[nJet]
  Float_t Jet_mass[64];                     //[nJet]
  Float_t Jet_muEF[64];                     //[nJet]
  Float_t Jet_muonSubtrFactor[64];          //[nJet]
  Float_t Jet_neEmEF[64];                   //[nJet]
  Float_t Jet_neHEF[64];                    //[nJet]
  ...
  TBranch *
      b_HLT_Ele24_eta2p1_WPTight_Gsf_TightChargedIsoPFTauHPS30_eta2p1_CrossL1; //!
...
#ifdef nano_events_cxx
nano_events::nano_events(TTree *tree) : fChain(0) {
  // if parameter tree is not specified (or zero), connect the file
  // used to generate this class and read the Tree.
  if (tree == 0) {
    TFile *f = (TFile *)gROOT->GetListOfFiles()->FindObject(
        "root://cmsxrootd.fnal.gov//store/data/Run2022E/JetMET/NANOAOD/"
        "22Sep2023-v1/30000/1c50d190-5161-4783-9870-71dd70d3beff.root");
    if (!f || !f->IsOpen()) {
      f = new TFile(
          "root://cmsxrootd.fnal.gov//store/data/Run2022E/JetMET/NANOAOD/"
          "22Sep2023-v1/30000/1c50d190-5161-4783-9870-71dd70d3beff.root");
...
nano_events::~nano_events() {
  if (!fChain)
    return;
  delete fChain->GetCurrentFile();
}

Int_t nano_events::GetEntry(Long64_t entry) {
  // Read contents of entry.
  if (!fChain)
    return 0;
  return fChain->GetEntry(entry);
}
Long64_t nano_events::LoadTree(Long64_t entry) {
...
void nano_events::Init(TTree *tree) {
  ...
  fChain->SetBranchAddress("LHEWeight_originalXWGTUP",
                           &LHEWeight_originalXWGTUP,
                           &b_LHEWeight_originalXWGTUP);
  ...
  fChain->SetBranchAddress("nLHEReweightingWeight", &nLHEReweightingWeight,
                           &b_nLHEReweightingWeight);
  fChain->SetBranchAddress("LHEReweightingWeight", &LHEReweightingWeight,
                           &b_LHEReweightingWeight);
  fChain->SetBranchAddress("nLHEScaleWeight", &nLHEScaleWeight,
                           &b_nLHEScaleWeight);
  ...
  // &b_nProton_multiRP); fChain->SetBranchAddress("Proton_multiRP_arm",
  // &Proton_multiRP_arm, &b_Proton_multiRP_arm);
  // fChain->SetBranchAddress("Proton_multiRP_t", &Proton_multiRP_t,
  // &b_Proton_multiRP_t); fChain->SetBranchAddress("Proton_multiRP_thetaX",
  // &Proton_multiRP_thetaX, &b_Proton_multiRP_thetaX);
  // fChain->SetBranchAddress("Proton_multiRP_thetaY", &Proton_multiRP_thetaY,
  // &b_Proton_multiRP_thetaY); fChain->SetBranchAddress("Proton_multiRP_time",
  // &Proton_multiRP_time, &b_Proton_multiRP_time);
  // fChain->SetBranchAddress("Proton_multiRP_timeUnc", &Proton_multiRP_timeUnc,
  // &b_Proton_multiRP_timeUnc); fChain->SetBranchAddress("Proton_multiRP_xi",
  // &Proton_multiRP_xi, &b_Proton_multiRP_xi);
  ...
  fChain->SetBranchAddress(
      ...
      &HLT_IsoMu20_eta2p1_TightChargedIsoPFTauHPS27_eta2p1_CrossL1,
      &b_HLT_IsoMu20_eta2p1_TightChargedIsoPFTauHPS27_eta2p1_CrossL1);
  fChain->SetBranchAddress(
  ...
  fChain->SetBranchAddress("HLT_DiPFJetAve260_HFJEC", &HLT_DiPFJetAve260_HFJEC,
                           &b_HLT_DiPFJetAve260_HFJEC);
  ...
  fChain->SetBranchAddress("HLT_PFJet40_GPUvsCPU", &HLT_PFJet40_GPUvsCPU,
                           &b_HLT_PFJet40_GPUvsCPU);
  fChain->SetBranchAddress(
      "HLT_MediumChargedIsoPFTau180HighPtRelaxedIso_Trk50_eta2p1",
      &HLT_MediumChargedIsoPFTau180HighPtRelaxedIso_Trk50_eta2p1,
      &b_HLT_MediumChargedIsoPFTau180HighPtRelaxedIso_Trk50_eta2p1);
  ...
  fChain->SetBranchAddress(
      ...
      &HLT_VBF_DoubleTightChargedIsoPFTauHPS20_Trk1_eta2p1,
      &b_HLT_VBF_DoubleTightChargedIsoPFTauHPS20_Trk1_eta2p1);
  fChain->SetBranchAddress(
  ...
  fChain->SetBranchAddress("HLT_DoubleMediumChargedIsoPFTauHPS40_Trk1_eta2p1",
                           &HLT_DoubleMediumChargedIsoPFTauHPS40_Trk1_eta2p1,
                           &b_HLT_DoubleMediumChargedIsoPFTauHPS40_Trk1_eta2p1);
  fChain->SetBranchAddress("HLT_DoubleTightChargedIsoPFTauHPS35_Trk1_eta2p1",
                           &HLT_DoubleTightChargedIsoPFTauHPS35_Trk1_eta2p1,
                           &b_HLT_DoubleTightChargedIsoPFTauHPS35_Trk1_eta2p1);
  fChain->SetBranchAddress(
  ...
  fChain->SetBranchAddress("HLT_HT430_DelayedJet40_DoubleDelay0p5nsInclusive",
                           &HLT_HT430_DelayedJet40_DoubleDelay0p5nsInclusive,
                           &b_HLT_HT430_DelayedJet40_DoubleDelay0p5nsInclusive);
  ...
  fChain->SetBranchAddress("HLT_HT430_DelayedJet40_SingleDelay0p5nsInclusive",
                           &HLT_HT430_DelayedJet40_SingleDelay0p5nsInclusive,
                           &b_HLT_HT430_DelayedJet40_SingleDelay0p5nsInclusive);
  fChain->SetBranchAddress("HLT_HT430_DelayedJet40_SingleDelay0p5nsTrackless",
                           &HLT_HT430_DelayedJet40_SingleDelay0p5nsTrackless,
                           &b_HLT_HT430_DelayedJet40_SingleDelay0p5nsTrackless);
  fChain->SetBranchAddress("HLT_HT430_DelayedJet40_SingleDelay1nsInclusive",
                           &HLT_HT430_DelayedJet40_SingleDelay1nsInclusive,
                           &b_HLT_HT430_DelayedJet40_SingleDelay1nsInclusive);
  fChain->SetBranchAddress("HLT_HT430_DelayedJet40_SingleDelay1p5nsInclusive",
                           &HLT_HT430_DelayedJet40_SingleDelay1p5nsInclusive,
                           &b_HLT_HT430_DelayedJet40_SingleDelay1p5nsInclusive);
  ...
  fChain->SetBranchAddress(
      ...
      &HLT_HT200_L1SingleLLPJet_DisplacedDijet40_Inclusive1PtrkShortSig5,
      &b_HLT_HT200_L1SingleLLPJet_DisplacedDijet40_Inclusive1PtrkShortSig5);
  fChain->SetBranchAddress("HLT_DiPhoton10Time1ns", &HLT_DiPhoton10Time1ns,
                           &b_HLT_DiPhoton10Time1ns);
  fChain->SetBranchAddress("HLT_DiPhoton10Time1p2ns", &HLT_DiPhoton10Time1p2ns,
                           &b_HLT_DiPhoton10Time1p2ns);
  ...
  fChain->SetBranchAddress("HLT_Mu50_L1SingleMuShower",
                           &HLT_Mu50_L1SingleMuShower,
                           &b_HLT_Mu50_L1SingleMuShower);
...
void nano_events::Show(Long64_t entry) {
...
Int_t nano_events::Cut(Long64_t entry) {
  // This function may be called from Loop.
  // returns  1 if entry is accepted.
  // returns -1 otherwise.
  return 1;
}
#endif // #ifdef nano_events_cxx
