...
#ifndef TreeMuonSystemCombinationRechits_H
#define TreeMuonSystemCombinationRechits_H

#define N_MAX_LEPTONS 100
#define N_MAX_JETS 100
#define N_MAX_CSC 200
#define N_MAX_CSCRECHITS 5000//two zeros added
#define N_MAX_DTRECHITS 20000//two zeros added
...
class TreeMuonSystemCombinationRechits
{

public:
  TreeMuonSystemCombinationRechits();
  ~TreeMuonSystemCombinationRechits();
  ...
  int           dtRechitClusterIndex[N_MAX_CSC];
  ...
  int           cscRechitClusterIndex[N_MAX_CSC];
  ...
  int   nCscClusteredRechits;
  float cscClusteredRechitsPhi[N_MAX_CSCRECHITS];
  float cscClusteredRechitsEta[N_MAX_CSCRECHITS];
  float cscClusteredRechitsX[N_MAX_CSCRECHITS];
  float cscClusteredRechitsY[N_MAX_CSCRECHITS];
  float cscClusteredRechitsZ[N_MAX_CSCRECHITS];
  float cscClusteredRechitsE[N_MAX_CSCRECHITS];
  float cscClusteredRechitsTpeak[N_MAX_CSCRECHITS];
  float cscClusteredRechitsTwire[N_MAX_CSCRECHITS];
  int cscClusteredRechitsQuality[N_MAX_CSCRECHITS];
  int cscClusteredRechitsChamber[N_MAX_CSCRECHITS];
  int cscClusteredRechitsStation[N_MAX_CSCRECHITS];
  int cscClusteredRechitsChannels[N_MAX_CSCRECHITS];
  int cscClusteredRechitsNStrips[N_MAX_CSCRECHITS];
  int cscClusteredRechitsHitWire[N_MAX_CSCRECHITS];
  int cscClusteredRechitsWGroupsBX[N_MAX_CSCRECHITS];
  int cscClusteredRechitsNWireGroups[N_MAX_CSCRECHITS];
  int cscClusteredRechitsDetId[N_MAX_CSCRECHITS];
  int cscClusteredRechitsIndex[N_MAX_CSCRECHITS];

  int   nDtClusteredRechits;
  float dtClusteredRechitCorrectX[N_MAX_DTRECHITS];
  float dtClusteredRechitCorrectY[N_MAX_DTRECHITS];
  float dtClusteredRechitCorrectZ[N_MAX_DTRECHITS];
  float dtClusteredRechitCorrectEta[N_MAX_DTRECHITS];
  float dtClusteredRechitCorrectPhi[N_MAX_DTRECHITS];
  float dtClusteredRechitTime[N_MAX_DTRECHITS];
  int dtClusteredRechitStation[N_MAX_DTRECHITS];
  int dtClusteredRechitWheel[N_MAX_DTRECHITS];
  int dtClusteredRechitLayer[N_MAX_DTRECHITS];
  int dtClusteredRechitSuperLayer[N_MAX_DTRECHITS];
  int dtClusteredRechitIndex[N_MAX_DTRECHITS];
