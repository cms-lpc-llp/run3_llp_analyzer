...
public:
  ...
  bool Flag_goodVertices, Flag_EcalDeadCellTriggerPrimitiveFilter,
      Flag_BadPFMuonFilter, Flag_BadPFMuonDzFilter,
      Flag_globalSuperTightHalo2016Filter, Flag_hfNoisyHitsFilter,
      Flag_eeBadScFilter, Flag_ecalBadCalibFilter, Flag_all;
  int mH, mX, ctau;
