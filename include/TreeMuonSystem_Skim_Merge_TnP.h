...
#ifndef TreeMuonSystem_Skim_Merge_TnP_H
#define TreeMuonSystem_Skim_Merge_TnP_H
...
class TreeMuonSystem_Skim_Merge_TnP
{

public:
  TreeMuonSystem_Skim_Merge_TnP();
  ~TreeMuonSystem_Skim_Merge_TnP();
  ...
  int nSoftJets2p65to3p139AllJets, nSoftJetsLargerThan2p65AllJets, nSoftJetsLargerThan3p139AllJets;
  float HTSoftJets2p65to3p139AllJets, HTSoftJetsLargerThan2p65AllJets, HTSoftJetsLargerThan3p139AllJets;
