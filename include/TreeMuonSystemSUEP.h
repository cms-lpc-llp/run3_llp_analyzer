...
#ifndef TreeMuonSystemSUEP_H
#define TreeMuonSystemSUEP_H
...
#define N_MAX_LLP 100//100//2000//0
#define N_MAX_LLP_DAU 300//100//2000//0
...
public:
  ...
  bool          dtRechitCluster_match_gLLP_dau1[N_MAX_CSC];
  bool          dtRechitCluster_match_gLLP_dau2[N_MAX_CSC];
  float         dtRechitCluster_match_gLLP_dau1_e[N_MAX_CSC];
  float         dtRechitCluster_match_gLLP_dau2_e[N_MAX_CSC];
  ...
  bool          cscRechitCluster_match_gLLP_dau1[N_MAX_CSC];
  bool          cscRechitCluster_match_gLLP_dau2[N_MAX_CSC];
  float         cscRechitCluster_match_gLLP_dau1_e[N_MAX_CSC];
  float         cscRechitCluster_match_gLLP_dau2_e[N_MAX_CSC];
  ...
  //daughters
  int nGLLPDau;
  float gLLP_daughter_travel_time[N_MAX_LLP_DAU];
  int   gLLP_daughter_id[N_MAX_LLP_DAU];
  float gLLP_daughter_prod_vertex_x[N_MAX_LLP_DAU];
  float gLLP_daughter_prod_vertex_y[N_MAX_LLP_DAU];
  float gLLP_daughter_prod_vertex_z[N_MAX_LLP_DAU];
  float gLLP_daughter_decay_vertex_x[N_MAX_LLP_DAU];
  float gLLP_daughter_decay_vertex_y[N_MAX_LLP_DAU];
  float gLLP_daughter_decay_vertex_z[N_MAX_LLP_DAU];
  float gLLP_daughter_px[N_MAX_LLP_DAU];
  float gLLP_daughter_py[N_MAX_LLP_DAU];
  float gLLP_daughter_pz[N_MAX_LLP_DAU];
  float gLLP_daughter_pt[N_MAX_LLP_DAU];
  float gLLP_daughter_eta[N_MAX_LLP_DAU];
  float gLLP_daughter_phi[N_MAX_LLP_DAU];
  float gLLP_daughter_eta_ecalcorr[N_MAX_LLP_DAU];
  float gLLP_daughter_phi_ecalcorr[N_MAX_LLP_DAU];
  float gLLP_daughter_e[N_MAX_LLP_DAU];
  float gLLP_daughter_mass[N_MAX_LLP_DAU];
