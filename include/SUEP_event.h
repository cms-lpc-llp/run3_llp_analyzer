...
//#define LLP_ARRAY_SIZE 2000 //10
//#define LLP_DAUGHTER_ARRAY_SIZE 4000 //20
//#define LLP_GRAND_DAUGHTER_ARRAY_SIZE 20000 //60
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           ncscRechits;
   Float_t         cscRechitsPhi[20000];   //[20000]
   ...
   Int_t           nDtRechits;
   Float_t         dtRechitsCorrectX[20000];   //[nDtRechits]
   Float_t         dtRechitsCorrectY[20000];   //[nDtRechits]
   Float_t         dtRechitsCorrectZ[20000];   //[nDtRechits]
   Float_t         dtRechitsCorrectEta[20000];   //[nDtRechits]
   Float_t         dtRechitsCorrectPhi[20000];   //[nDtRechits]
   Float_t         dtRechitsTime[20000];   //[nDtRechits]
   Int_t           dtRechitsStation[20000];   //[nDtRechits]
   Int_t           dtRechitsWheel[20000];   //[nDtRechits]
   Int_t           dtRechitsSector[20000];   //[nDtRechits]
   Int_t           dtRechitsLayer[20000];   //[nDtRechits]
   Int_t           dtRechitsSuperLayer[20000];   //[nDtRechits]
   ...
   Int_t           nGenLLP;
   Float_t         gLLP_decay_vertex_x[100];
   Float_t         gLLP_decay_vertex_y[100];
   Float_t         gLLP_decay_vertex_z[100];
   Float_t         gLLP_beta[100];
   Float_t         gLLP_e[100];
   Float_t         gLLP_pt[100];
   Float_t         gLLP_eta[100];
   Float_t         gLLP_phi[100];
   Bool_t          gLLP_csc[100];
   Bool_t          gLLP_dt[100];
   Float_t         gLLP_travel_time[100];
   Int_t           nGenLLPDau;
   Int_t           gLLP_daughter_id[200];//[4];
   Float_t         gLLP_daughter_pt[200];//[4];
   Float_t         gLLP_daughter_eta[200];//[4];
   Float_t         gLLP_daughter_phi[200];//[4];
   Float_t         gLLP_daughter_eta_ecalcorr[200];//[4];
   Float_t         gLLP_daughter_phi_ecalcorr[200];//[4];
   Float_t         gLLP_daughter_e[200];//[4];
   Float_t         gLLP_daughter_mass[200];//[4];
   Float_t         gLLP_daughter_decay_vertex_x[200];//[4];
   Float_t         gLLP_daughter_decay_vertex_y[200];//[4];
   Float_t         gLLP_daughter_decay_vertex_z[200];//[4];
   Float_t         gLLP_daughter_prod_vertex_x[200];//[4];
   Float_t         gLLP_daughter_prod_vertex_y[200];//[4];
   Float_t         gLLP_daughter_prod_vertex_z[200];//[4];
   Float_t         gen_time[200];//[4];
   Float_t         gen_time_pv[200];//[4];
   Float_t         photon_travel_time[200];//[4];
   Float_t         photon_travel_time_pv[200];//[4];
   Float_t         gLLP_daughter_travel_time[200];//[4];
   //Int_t           gLLP_grandaughter_id[100];//[20];
   //Float_t         gLLP_grandaughter_pt[100];//[20];
   //Float_t         gLLP_grandaughter_eta[100];//[20];
   //Float_t         gLLP_grandaughter_phi[100];//[20];
   //Float_t         gLLP_grandaughter_eta_ecalcorr[100];//[20];
   //Float_t         gLLP_grandaughter_phi_ecalcorr[100];//[20];
   //Float_t         gLLP_grandaughter_e[100];//[20];
   //Float_t         gLLP_grandaughter_mass[100];//[20];
   //Float_t         gen_time_dau[100];//[20];
   //Float_t         gen_time_dau_pv[100];//[20];
   //Float_t         photon_travel_time_dau[100];//[20];
   //Float_t         photon_travel_time_dau_pv[100];//[20];
   //Float_t         gLLP_grandaughter_travel_time[100];//[20];
   ...
   TBranch        *b_dtRechitsCorrectX;   //!
   TBranch        *b_dtRechitsCorrectY;   //!
   TBranch        *b_dtRechitsCorrectZ;   //!
   TBranch        *b_dtRechitsCorrectEta;   //!
   TBranch        *b_dtRechitsCorrectPhi;   //!
   TBranch        *b_dtRechitsTime;   //!
   TBranch        *b_dtRechitsStation;   //!
   TBranch        *b_dtRechitsWheel;   //!
   TBranch        *b_dtRechitsSector;   //!
   TBranch        *b_dtRechitsLayer;   //!
   TBranch        *b_dtRechitsSuperLayer;   //!
   ...
   TBranch        *b_gLLP_daughter_decay_vertex_x;   //!
   TBranch        *b_gLLP_daughter_decay_vertex_y;   //!
   TBranch        *b_gLLP_daughter_decay_vertex_z;   //!
   TBranch        *b_gLLP_daughter_prod_vertex_x;   //!
   TBranch        *b_gLLP_daughter_prod_vertex_y;   //!
   TBranch        *b_gLLP_daughter_prod_vertex_z;   //!
   TBranch        *b_gen_time;   //!
...
#ifdef SUEP_event_cxx
SUEP_event::SUEP_event(TTree *tree) : fChain(0)
{
...
SUEP_event::~SUEP_event()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t SUEP_event::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t SUEP_event::LoadTree(Long64_t entry)
{
...
void SUEP_event::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("dtRechitsCorrectX", dtRechitsCorrectX, &b_dtRechitsCorrectX);
   fChain->SetBranchAddress("dtRechitsCorrectY", dtRechitsCorrectY, &b_dtRechitsCorrectY);
   fChain->SetBranchAddress("dtRechitsCorrectZ", dtRechitsCorrectZ, &b_dtRechitsCorrectZ);
   fChain->SetBranchAddress("dtRechitsCorrectEta", dtRechitsCorrectEta, &b_dtRechitsCorrectEta);
   fChain->SetBranchAddress("dtRechitsCorrectPhi", dtRechitsCorrectPhi, &b_dtRechitsCorrectPhi);
   fChain->SetBranchAddress("dtRechitsTime", dtRechitsTime, &b_dtRechitsTime);
   ...
   fChain->SetBranchAddress("dtRechitsSector", dtRechitsSector, &b_dtRechitsSector);
   fChain->SetBranchAddress("dtRechitsLayer", dtRechitsLayer, &b_dtRechitsLayer);
   fChain->SetBranchAddress("dtRechitsSuperLayer", dtRechitsSuperLayer, &b_dtRechitsSuperLayer);
   ...
   fChain->SetBranchAddress("nGenLLP", &nGenLLP, &b_nGenLLP);
   ...
   fChain->SetBranchAddress("nGenLLPDau", &nGenLLPDau, &b_nGenLLPDau);
   ...
   fChain->SetBranchAddress("gLLP_daughter_decay_vertex_x", gLLP_daughter_decay_vertex_x, &b_gLLP_daughter_decay_vertex_x);
   fChain->SetBranchAddress("gLLP_daughter_decay_vertex_y", gLLP_daughter_decay_vertex_y, &b_gLLP_daughter_decay_vertex_y);
   fChain->SetBranchAddress("gLLP_daughter_decay_vertex_z", gLLP_daughter_decay_vertex_z, &b_gLLP_daughter_decay_vertex_z);
   fChain->SetBranchAddress("gLLP_daughter_prod_vertex_x", gLLP_daughter_prod_vertex_x, &b_gLLP_daughter_prod_vertex_x);
   fChain->SetBranchAddress("gLLP_daughter_prod_vertex_y", gLLP_daughter_prod_vertex_y, &b_gLLP_daughter_prod_vertex_y);
   fChain->SetBranchAddress("gLLP_daughter_prod_vertex_z", gLLP_daughter_prod_vertex_z, &b_gLLP_daughter_prod_vertex_z);
...
void SUEP_event::Show(Long64_t entry)
{
...
Int_t SUEP_event::Cut(Long64_t entry)
{
