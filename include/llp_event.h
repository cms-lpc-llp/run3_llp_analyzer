...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         gLLP_decay_vertex_x[2000];
   Float_t         gLLP_decay_vertex_y[2000];
   Float_t         gLLP_decay_vertex_z[2000];
   Float_t         gLLP_beta[2000];
   Float_t         gLLP_e[2000];
   Float_t         gLLP_pt[2000];
   Float_t         gLLP_eta[2000];
   Float_t         gLLP_phi[2000];
   Bool_t          gLLP_csc[2000];
   Bool_t          gLLP_dt[2000];
   Float_t         gLLP_travel_time[2000];
   Int_t           gLLP_daughter_id[4000];
   Float_t         gLLP_daughter_pt[4000];
   Float_t         gLLP_daughter_eta[4000];
   Float_t         gLLP_daughter_phi[4000];
   Float_t         gLLP_daughter_eta_ecalcorr[4000];
   Float_t         gLLP_daughter_phi_ecalcorr[4000];
   Float_t         gLLP_daughter_e[4000];
   Float_t         gLLP_daughter_mass[4000];
   Float_t         gen_time[4000];
   Float_t         gen_time_pv[4000];
   Float_t         photon_travel_time[4000];
   Float_t         photon_travel_time_pv[4000];
   Float_t         gLLP_daughter_travel_time[4000];
   Int_t           gLLP_grandaughter_id[20000];
   Float_t         gLLP_grandaughter_pt[20000];
   Float_t         gLLP_grandaughter_eta[20000];
   Float_t         gLLP_grandaughter_phi[20000];
   Float_t         gLLP_grandaughter_eta_ecalcorr[20000];
   Float_t         gLLP_grandaughter_phi_ecalcorr[20000];
   Float_t         gLLP_grandaughter_e[20000];
   Float_t         gLLP_grandaughter_mass[20000];
   Float_t         gen_time_dau[20000];
   Float_t         gen_time_dau_pv[20000];
   Float_t         photon_travel_time_dau[20000];
   Float_t         photon_travel_time_dau_pv[20000];
   Float_t         gLLP_grandaughter_travel_time[20000];
