...
public:
   ...
   Int_t nJet;
   UChar_t Jet_jetId[80];                    //[nJet]
   UChar_t Jet_nConstituents[80];            //[nJet]
   UChar_t Jet_nElectrons[80];               //[nJet]
   UChar_t Jet_nMuons[80];                   //[nJet]
   UChar_t Jet_nSVs[80];                     //[nJet]
   Short_t Jet_electronIdx1[80];             //[nJet]
   Short_t Jet_electronIdx2[80];             //[nJet]
   Short_t Jet_muonIdx1[80];                 //[nJet]
   Short_t Jet_muonIdx2[80];                 //[nJet]
   Short_t Jet_svIdx1[80];                   //[nJet]
   Short_t Jet_svIdx2[80];                   //[nJet]
   Int_t Jet_hfadjacentEtaStripsSize[80];    //[nJet]
   Int_t Jet_hfcentralEtaStripSize[80];      //[nJet]
   Float_t Jet_PNetRegPtRawCorr[80];         //[nJet]
   Float_t Jet_PNetRegPtRawCorrNeutrino[80]; //[nJet]
   Float_t Jet_PNetRegPtRawRes[80];          //[nJet]
   ...
   Float_t Jet_btagPNetB[80];                //[nJet]
   Float_t Jet_btagPNetCvB[80];              //[nJet]
   Float_t Jet_btagPNetCvL[80];              //[nJet]
   Float_t Jet_btagPNetQvG[80];              //[nJet]
   Float_t Jet_btagPNetTauVJet[80];          //[nJet]
   Float_t Jet_btagRobustParTAK4B[80];       //[nJet]
   Float_t Jet_btagRobustParTAK4CvB[80];     //[nJet]
   Float_t Jet_btagRobustParTAK4CvL[80];     //[nJet]
   Float_t Jet_btagRobustParTAK4QG[80];      //[nJet]
