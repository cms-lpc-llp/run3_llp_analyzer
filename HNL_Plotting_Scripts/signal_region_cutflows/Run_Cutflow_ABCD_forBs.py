...
def run_sample(
    ...
    if is_mc or float(cfg.get("signal_xsec", 1)) != 1:
        ...
        normalization_factor = Produce_Cutflow_v2_forBs.processed_lumi * float(cfg.get("signal_xsec", 1)) / num_events

    
    cutflow_df, abcd_df = Produce_Cutflow_v2_forBs.makeCutflow(
        events,
