...
python3 run_HNL_Processor.py \
  ...
  --label "${e_label}_looseIso" \
  --is-mc true \
  --iso loose \
  --sample root://cmseos.fnal.gov//store/group/lpclonglived/amalbert/HNL_Tau_Search/analyzer_update_021726/HNL_e_mN_2_ctau_1000/normalized/HNL_e_mN_2_ctau_1000_109080pb_weighted.root \
  --label "${e_label}_tightIso" \
  --is-mc true \
  --iso tight \
  --sample root://cmseos.fnal.gov//store/group/lpclonglived/amalbert/HNL_Tau_Search/analyzer_update_021726/HNL_e_mN_2_ctau_1000/normalized/HNL_e_mN_2_ctau_1000_109080pb_weighted.root \
  --label "${e_label}_vtightIso" \
  --is-mc true \
  --iso vtight \
  --sample root://cmseos.fnal.gov//store/group/lpclonglived/amalbert/HNL_Tau_Search/analyzer_update_021726/HNL_e_mN_2_ctau_1000/normalized/HNL_e_mN_2_ctau_1000_109080pb_weighted.root \
  --label "${e_label}_vvtightIso" \
  --is-mc true \
  --iso vvtight \
  --hists electron_pt \
  --outdir e_category_MET_scanISO_signal
