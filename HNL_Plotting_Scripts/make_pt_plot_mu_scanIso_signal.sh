...
python3 run_HNL_Processor.py \
  --flavor mu \
  --not_normalized \
  --sample root://cmseos.fnal.gov//store/group/lpclonglived/amalbert/HNL_Tau_Search/analyzer_update_012026/HNL_mu_mN_2_ctau_1000/normalized/HNL_mu_mN_2_ctau_1000_109080pb_weighted.root \
  --label "${mu_label}_looseIso" \
  --is-mc true \
  --iso loose \
  --sample root://cmseos.fnal.gov//store/group/lpclonglived/amalbert/HNL_Tau_Search/analyzer_update_012026/HNL_mu_mN_2_ctau_1000/normalized/HNL_mu_mN_2_ctau_1000_109080pb_weighted.root \
  --label "${mu_label}_tightIso" \
  --is-mc true \
  --iso tight \
  --sample root://cmseos.fnal.gov//store/group/lpclonglived/amalbert/HNL_Tau_Search/analyzer_update_012026/HNL_mu_mN_2_ctau_1000/normalized/HNL_mu_mN_2_ctau_1000_109080pb_weighted.root \
  --label "${mu_label}_vtightIso" \
  --is-mc true \
  --iso vtight \
  --sample root://cmseos.fnal.gov//store/group/lpclonglived/amalbert/HNL_Tau_Search/analyzer_update_012026/HNL_mu_mN_2_ctau_1000/normalized/HNL_mu_mN_2_ctau_1000_109080pb_weighted.root \
  --label "${mu_label}_vvtightIso" \
  --is-mc true \
  --iso vvtight \
  --hists muon_pt \
  --outdir mu_category_MET_scanISO_signal
