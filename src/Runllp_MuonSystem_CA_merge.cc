...
void usage() {
  std::cerr << "Usage: Runllp_MuonSystem_CA_merge  <input list>  [options]\n[options]:\n"
            << "-d  --isData\n"
...
int main(int argc, char* argv[]) {
  ...
  llp_MuonSystem_CA_merge analyzer(theChain);

  //------ EXECUTE ------//
  cout << "Executing llp_MuonSystem_CA_merge..." << endl;
  analyzer.EnableAll();
