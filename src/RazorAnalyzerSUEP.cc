...
//RazorAnalyzerSUEP::RazorAnalyzerSUEP(TTree *tree) : llp_event(tree)
RazorAnalyzerSUEP::RazorAnalyzerSUEP(TTree *tree) : SUEP_event(tree)
{
...
RazorAnalyzerSUEP::~RazorAnalyzerSUEP()
{
}

void RazorAnalyzerSUEP::Analyze(bool isData, int option, string outputFileName, string label, int mh, int mx, int ctau, int T)
{
    cout << "Analyze method called on base RazorAnalyzerSUEP instance.  Parameters were: " << isData << " " << option << " " << outputFileName << " " << label << endl;
}
...
void RazorAnalyzerSUEP::EnableAll()
{
    // fChain->SetBranchStatus("*", 1);
    EnableEventInfo();
    EnableMuons();
...
void RazorAnalyzerSUEP::EnableEventInfo()
{
...
void RazorAnalyzerSUEP::EnablePVAll()
{
...
void RazorAnalyzerSUEP::EnablePileup()
{
...
void RazorAnalyzerSUEP::EnableMuons()
{
...
void RazorAnalyzerSUEP::EnableElectrons()
{
...
void RazorAnalyzerSUEP::EnableTaus()
{
...
void RazorAnalyzerSUEP::EnableIsoPFCandidates()
{
...
void RazorAnalyzerSUEP::EnablePhotons()
{
...
void RazorAnalyzerSUEP::EnableCaloJets()
{
...
void RazorAnalyzerSUEP::EnableJets()
{
...
void RazorAnalyzerSUEP::EnableFatJets()
{
...
void RazorAnalyzerSUEP::EnableMet()
{
...
void RazorAnalyzerSUEP::EnableRazor() {

};
void RazorAnalyzerSUEP::EnableDT()
{
    fChain->SetBranchStatus("nDtRechits", 1);
    fChain->SetBranchStatus("dtRechitsStation", 1);
    fChain->SetBranchStatus("dtRechitsWheel", 1);
    fChain->SetBranchStatus("dtRechitsCorrectX", 1);
    fChain->SetBranchStatus("dtRechitsCorrectY", 1);
    fChain->SetBranchStatus("dtRechitsCorrectZ", 1);
    fChain->SetBranchStatus("dtRechitsCorrectEta", 1);
    fChain->SetBranchStatus("dtRechitsCorrectPhi", 1);
    fChain->SetBranchStatus("dtRechitsTime", 1);
    fChain->SetBranchStatus("dtRechitsSuperLayer", 1);
    fChain->SetBranchStatus("dtRechitsLayer", 1);
...
void RazorAnalyzerSUEP::EnableCSC()
{
...
void RazorAnalyzerSUEP::EnableMC()
{
...
void RazorAnalyzerSUEP::EnableGenParticles()
{
...
void RazorAnalyzerSUEP::EnableLLP()
{
    fChain->SetBranchStatus("nGenLLP", 1);
    ...
    fChain->SetBranchStatus("nGenLLPDau", 1);
    ...
    fChain->SetBranchStatus("gLLP_daughter_px", 1);
    fChain->SetBranchStatus("gLLP_daughter_py", 1);
    fChain->SetBranchStatus("gLLP_daughter_pz", 1);
    fChain->SetBranchStatus("gLLP_daughter_mass", 1);
    fChain->SetBranchStatus("gLLP_daughter_id", 1);
    fChain->SetBranchStatus("gLLP_daughter_prod_vertex_x", 1);
    fChain->SetBranchStatus("gLLP_daughter_prod_vertex_y", 1);
    fChain->SetBranchStatus("gLLP_daughter_prod_vertex_z", 1);
    fChain->SetBranchStatus("gLLP_daughter_decay_vertex_x", 1);
    fChain->SetBranchStatus("gLLP_daughter_decay_vertex_y", 1);
    fChain->SetBranchStatus("gLLP_daughter_decay_vertex_z", 1);
    //missing travel time, etc
}

void RazorAnalyzerSUEP::EnableEcalRechits()
{
...
void RazorAnalyzerSUEP::EnableTracks()
{
...
double RazorAnalyzerSUEP::deltaPhi(double phi1, double phi2)
{
...
double RazorAnalyzerSUEP::deltaR(double eta1, double phi1, double eta2, double phi2)
{
...
TLorentzVector RazorAnalyzerSUEP::makeTLorentzVector(double pt, double eta, double phi, double energy)
{
    TLorentzVector vec;
...
TLorentzVector RazorAnalyzerSUEP::makeTLorentzVectorPtEtaPhiM(double pt, double eta, double phi, double mass)
{
    TLorentzVector vec;
