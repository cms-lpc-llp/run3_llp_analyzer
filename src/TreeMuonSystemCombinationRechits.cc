...
// Constructor
TreeMuonSystemCombinationRechits::TreeMuonSystemCombinationRechits()
{
  InitVariables();
};
TreeMuonSystemCombinationRechits::~TreeMuonSystemCombinationRechits()
...
void TreeMuonSystemCombinationRechits::InitVariables()
{
  ...
  nCscClusteredRechits = 0;
  for(int i = 0; i < N_MAX_CSCRECHITS; i++){
    cscClusteredRechitsPhi[i] = -999.;
    cscClusteredRechitsPhi[i] = -999.;
    cscClusteredRechitsEta[i] = -999.;
    cscClusteredRechitsX[i] = -999.;
    cscClusteredRechitsY[i] = -999.;
    cscClusteredRechitsZ[i] = -999.;
    cscClusteredRechitsE[i] = -999.;
    cscClusteredRechitsTpeak[i] = -999.;
    cscClusteredRechitsTwire[i] = -999.;
    cscClusteredRechitsQuality[i] = -999;
    cscClusteredRechitsChamber[i] = -999;
    cscClusteredRechitsStation[i] = -999;
    cscClusteredRechitsChannels[i] = -999;
    cscClusteredRechitsNStrips[i] = -999;
    cscClusteredRechitsHitWire[i] = -999;
    cscClusteredRechitsWGroupsBX[i] = -999;
    cscClusteredRechitsNWireGroups[i] = -999;
    cscClusteredRechitsDetId[i] = -999;
    cscClusteredRechitsIndex[i] = -1;
  }
  ...
  //for(int i = 0; i < N_MAX_CSCRECHITS; i++){
  //  std::cout << i << std::endl;
  //  std:: cout << cscClusteredRechitsX[i] << std::endl;
  //}

  nDtClusteredRechits = 0;
  //std::cout<< "dtClusteredRechitCorrectX size " << sizeof(dtClusteredRechitCorrectX)/sizeof(dtClusteredRechitCorrectX[0]) << std::endl;
  //std::cout<< "N_MAX_DTRECHITS " << N_MAX_DTRECHITS << std::endl;
  //std::cout<<" -- "<<std::endl;
  //std::cout<<"DT:"<<std::endl;
  //for(int i = 0; i < N_MAX_DTRECHITS; i++){
    //std::cout << i << std::endl;
    //dtClusteredRechitCorrectX[i] = -999.;
    //std:: cout << dtClusteredRechitCorrectX[i] << std::endl;
  //}

  for(int i = 0; i < N_MAX_DTRECHITS; i++){
    dtClusteredRechitCorrectX[i] = -999.;
    dtClusteredRechitCorrectY[i] = -999.;
    dtClusteredRechitCorrectZ[i] = -999.;
    dtClusteredRechitCorrectEta[i] = -999.;
    dtClusteredRechitCorrectPhi[i] = -999.;
    dtClusteredRechitTime[i] = -999.;
    dtClusteredRechitStation[i] = -999;
    dtClusteredRechitWheel[i] = -999;
    dtClusteredRechitLayer[i] = -999;
    dtClusteredRechitSuperLayer[i] = -999;
    dtClusteredRechitIndex[i] = -1;
  }
  //std::cout<< "until here it works " << N_MAX_DTRECHITS << std::endl;

};

void TreeMuonSystemCombinationRechits::InitTree()
{
  assert(tree_);
  InitVariables();
  ...
  tree_->SetBranchAddress("dtRechitCluster_match_RB1_dPhi0p5",             dtRechitCluster_match_RB1_dPhi0p5);
    ...
    tree_->SetBranchAddress("dtRechitClusterIndex",                dtRechitClusterIndex);
  ...
  tree_->SetBranchAddress("cscRechitClusterIndex",                cscRechitClusterIndex);
  ...
  tree_->SetBranchAddress("nCscClusteredRechits",     &nCscClusteredRechits);
  tree_->SetBranchAddress("cscClusteredRechitsPhi", cscClusteredRechitsPhi);
  tree_->SetBranchAddress("cscClusteredRechitsEta", cscClusteredRechitsEta);
  tree_->SetBranchAddress("cscClusteredRechitsX", cscClusteredRechitsX);
  tree_->SetBranchAddress("cscClusteredRechitsY", cscClusteredRechitsY);
  tree_->SetBranchAddress("cscClusteredRechitsZ", cscClusteredRechitsZ);
  tree_->SetBranchAddress("cscClusteredRechitsE", cscClusteredRechitsE);
  tree_->SetBranchAddress("cscClusteredRechitsTpeak", cscClusteredRechitsTpeak);
  tree_->SetBranchAddress("cscClusteredRechitsTwire", cscClusteredRechitsTwire);
  tree_->SetBranchAddress("cscClusteredRechitsQuality", cscClusteredRechitsQuality);
  tree_->SetBranchAddress("cscClusteredRechitsChamber", cscClusteredRechitsChamber);
  tree_->SetBranchAddress("cscClusteredRechitsStation", cscClusteredRechitsStation);
  tree_->SetBranchAddress("cscClusteredRechitsChannels", cscClusteredRechitsChannels);
  tree_->SetBranchAddress("cscClusteredRechitsNStrips", cscClusteredRechitsNStrips);
  tree_->SetBranchAddress("cscClusteredRechitsHitWire", cscClusteredRechitsHitWire);
  tree_->SetBranchAddress("cscClusteredRechitsWGroupsBX", cscClusteredRechitsWGroupsBX);
  tree_->SetBranchAddress("cscClusteredRechitsNWireGroups", cscClusteredRechitsNWireGroups);
  tree_->SetBranchAddress("cscClusteredRechitsDetId", cscClusteredRechitsDetId);
  tree_->SetBranchAddress("cscClusteredRechitsIndex", cscClusteredRechitsIndex);

  tree_->SetBranchAddress("nDtClusteredRechits",     &nDtClusteredRechits);
  tree_->SetBranchAddress("dtClusteredRechitCorrectX", dtClusteredRechitCorrectX);
  tree_->SetBranchAddress("dtClusteredRechitCorrectY", dtClusteredRechitCorrectY);
  tree_->SetBranchAddress("dtClusteredRechitCorrectZ", dtClusteredRechitCorrectZ);
  tree_->SetBranchAddress("dtClusteredRechitCorrectEta", dtClusteredRechitCorrectEta);
  tree_->SetBranchAddress("dtClusteredRechitCorrectPhi", dtClusteredRechitCorrectPhi);
  tree_->SetBranchAddress("dtClusteredRechitTime", dtClusteredRechitTime);
  tree_->SetBranchAddress("dtClusteredRechitStation", dtClusteredRechitStation);
  tree_->SetBranchAddress("dtClusteredRechitWheel", dtClusteredRechitWheel);
  tree_->SetBranchAddress("dtClusteredRechitLayer", dtClusteredRechitLayer);
  tree_->SetBranchAddress("dtClusteredRechitSuperLayer", dtClusteredRechitSuperLayer);
  tree_->SetBranchAddress("dtClusteredRechitIndex", dtClusteredRechitIndex);

};

void TreeMuonSystemCombinationRechits::LoadTree(const char* file)
{
  f_ = TFile::Open(file);
  assert(f_);
...
void TreeMuonSystemCombinationRechits::CreateTree()
{
  ...
  tree_->Branch("nDtRings",             &nDtRings, "nDtRings/I");
    ...
    tree_->Branch("cscRechitClusterIndex",             cscRechitClusterIndex,             "cscRechitClusterIndex[nCscRechitClusters]/I");
    ...
    tree_->Branch("dtRechitClusterNOppositeSegStation4",             dtRechitClusterNOppositeSegStation4,             "dtRechitClusterNOppositeSegStation4[nDtRechitClusters]/I");
        ...
        tree_->Branch("dtRechitClusterIndex",             dtRechitClusterIndex,             "dtRechitClusterIndex[nDtRechitClusters]/I");
  ...
  //csc hits
  tree_->Branch("nCscClusteredRechits",     &nCscClusteredRechits,    "nCscClusteredRechits/I");
  tree_->Branch("cscClusteredRechitsPhi", cscClusteredRechitsPhi, "cscClusteredRechitsPhi[nCscClusteredRechits]/F");
  tree_->Branch("cscClusteredRechitsEta", cscClusteredRechitsEta, "cscClusteredRechitsEta[nCscClusteredRechits]/F");
  tree_->Branch("cscClusteredRechitsX", cscClusteredRechitsX, "cscClusteredRechitsX[nCscClusteredRechits]/F");
  tree_->Branch("cscClusteredRechitsY", cscClusteredRechitsY, "cscClusteredRechitsY[nCscClusteredRechits]/F");
  tree_->Branch("cscClusteredRechitsZ", cscClusteredRechitsZ, "cscClusteredRechitsZ[nCscClusteredRechits]/F");
  tree_->Branch("cscClusteredRechitsE", cscClusteredRechitsE, "cscClusteredRechitsE[nCscClusteredRechits]/F");
  tree_->Branch("cscClusteredRechitsTpeak", cscClusteredRechitsTpeak, "cscClusteredRechitsTpeak[nCscClusteredRechits]/F");
  tree_->Branch("cscClusteredRechitsTwire", cscClusteredRechitsTwire, "cscClusteredRechitsTwire[nCscClusteredRechits]/F");
  tree_->Branch("cscClusteredRechitsQuality", cscClusteredRechitsQuality, "cscClusteredRechitsQuality[nCscClusteredRechits]/I");
  tree_->Branch("cscClusteredRechitsChamber", cscClusteredRechitsChamber, "cscClusteredRechitsChamber[nCscClusteredRechits]/I");
  tree_->Branch("cscClusteredRechitsStation", cscClusteredRechitsStation, "cscClusteredRechitsStation[nCscClusteredRechits]/I");
  tree_->Branch("cscClusteredRechitsChannels", cscClusteredRechitsChannels, "cscClusteredRechitsChannels[nCscClusteredRechits]/I");
  tree_->Branch("cscClusteredRechitsNStrips", cscClusteredRechitsNStrips, "cscClusteredRechitsNStrips[nCscClusteredRechits]/I");
  tree_->Branch("cscClusteredRechitsHitWire", cscClusteredRechitsHitWire, "cscClusteredRechitsHitWire[nCscClusteredRechits]/I");
  tree_->Branch("cscClusteredRechitsWGroupsBX", cscClusteredRechitsWGroupsBX, "cscClusteredRechitsWGroupsBX[nCscClusteredRechits]/I");
  tree_->Branch("cscClusteredRechitsNWireGroups", cscClusteredRechitsNWireGroups, "cscClusteredRechitsNWireGroups[nCscClusteredRechits]/I");
  tree_->Branch("cscClusteredRechitsDetId", cscClusteredRechitsDetId, "cscClusteredRechitsDetId[nCscClusteredRechits]/I");
  tree_->Branch("cscClusteredRechitsIndex", cscClusteredRechitsIndex, "cscClusteredRechitsIndex[nCscClusteredRechits]/I");

  tree_->Branch("nDtClusteredRechits",     &nDtClusteredRechits,    "nDtClusteredRechits/I");
  tree_->Branch("dtClusteredRechitCorrectX", dtClusteredRechitCorrectX, "dtClusteredRechitCorrectX[nDtClusteredRechits]/F");
  tree_->Branch("dtClusteredRechitCorrectY", dtClusteredRechitCorrectY, "dtClusteredRechitCorrectY[nDtClusteredRechits]/F");
  tree_->Branch("dtClusteredRechitCorrectZ", dtClusteredRechitCorrectZ, "dtClusteredRechitCorrectZ[nDtClusteredRechits]/F");
  tree_->Branch("dtClusteredRechitCorrectEta", dtClusteredRechitCorrectEta, "dtClusteredRechitCorrectEta[nDtClusteredRechits]/F");
  tree_->Branch("dtClusteredRechitCorrectPhi", dtClusteredRechitCorrectPhi, "dtClusteredRechitCorrectPhi[nDtClusteredRechits]/F");
  tree_->Branch("dtClusteredRechitTime", dtClusteredRechitTime, "dtClusteredRechitTime[nDtClusteredRechits]/F");
  tree_->Branch("dtClusteredRechitStation", dtClusteredRechitStation, "dtClusteredRechitStation[nDtClusteredRechits]/I");
  tree_->Branch("dtClusteredRechitWheel", dtClusteredRechitWheel, "dtClusteredRechitWheel[nDtClusteredRechits]/I");
  tree_->Branch("dtClusteredRechitLayer", dtClusteredRechitLayer, "dtClusteredRechitLayer[nDtClusteredRechits]/I");
  tree_->Branch("dtClusteredRechitSuperLayer", dtClusteredRechitSuperLayer, "dtClusteredRechitSuperLayer[nDtClusteredRechits]/I");
  tree_->Branch("dtClusteredRechitIndex", dtClusteredRechitIndex, "dtClusteredRechitIndex[nDtClusteredRechits]/I");
