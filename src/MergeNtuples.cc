...
int main(int argc, char* argv[]) {
  ...
  for (uint n = 0; n < NEventsTree1; n++) {
    ...
    bool noise_filter = nano.Flag_eeBadScFilter && nano.Flag_hfNoisyHitsFilter && nano.Flag_BadPFMuonDzFilter && nano.Flag_BadPFMuonFilter && nano.Flag_EcalDeadCellTriggerPrimitiveFilter && nano.Flag_globalSuperTightHalo2016Filter && nano.Flag_goodVertices;
