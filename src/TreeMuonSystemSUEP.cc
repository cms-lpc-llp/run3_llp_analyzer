...
// Constructor
TreeMuonSystemSUEP::TreeMuonSystemSUEP()
{
  InitVariables();
};
TreeMuonSystemSUEP::~TreeMuonSystemSUEP()
...
void TreeMuonSystemSUEP::InitVariables()
{
...
Flag_all = false;
  ...
  for( int i = 0; i < N_MAX_CSC; i++ )
  {
        ...
        cscRechitCluster_match_gLLP_dau1[i] = false;
        cscRechitCluster_match_gLLP_dau2[i] = false;
        cscRechitCluster_match_gLLP_dau1_e[i] = 999.;
        cscRechitCluster_match_gLLP_dau2_e[i] = 999.;
        ...
        dtRechitCluster_match_RB1_dPhi0p5[i] = 0;
          ...
          dtRechitCluster_match_gLLP_dau1[i] = false;
          dtRechitCluster_match_gLLP_dau2[i] = false;
          dtRechitCluster_match_gLLP_dau1_e[i] = 999.;
          dtRechitCluster_match_gLLP_dau2_e[i] = 999.;
  ...
  for(int i = 0;i<N_MAX_LLP;i++)
  {
   ...
   nGLLPDau = 0;
   for(int i = 0;i<N_MAX_LLP_DAU;i++)
     {
       gLLP_daughter_id[i] = 0;
       gLLP_daughter_prod_vertex_x[i] = -666666.;
       gLLP_daughter_prod_vertex_y[i] = -666666.;
       gLLP_daughter_prod_vertex_z[i] = -666666.;
       gLLP_daughter_decay_vertex_x[i] = -666666.;
       gLLP_daughter_decay_vertex_y[i] = -666666.;
       gLLP_daughter_decay_vertex_z[i] = -666666.;
       gLLP_daughter_px[i] = -666666.;
       gLLP_daughter_py[i] = -666666.;
       gLLP_daughter_pz[i] = -666666.;
       gLLP_daughter_pt[i] = -666666.;
       gLLP_daughter_eta[i] = -666666.;
       gLLP_daughter_phi[i] = -666666.;
       gLLP_daughter_eta_ecalcorr[i] = -666666.;
       gLLP_daughter_phi_ecalcorr[i] = -666666.;
       gLLP_daughter_e[i] = -666666.;
       gLLP_daughter_mass[i] = -666666.;

       gLLP_daughter_travel_time[i] = -666666.;
       //gen_time[i] = -666666.;
       //gen_time_pv[i] = -666666.;
       //photon_travel_time[i] = -666666.;
       //photon_travel_time_pv[i] = -666666.;      
     }
...
void TreeMuonSystemSUEP::InitTree()
{
  assert(tree_);
  InitVariables();
  ...
  tree_->SetBranchAddress("dtRechitCluster_match_gLLP_dau1",             &dtRechitCluster_match_gLLP_dau1);
  tree_->SetBranchAddress("dtRechitCluster_match_gLLP_dau2",             &dtRechitCluster_match_gLLP_dau2);
  tree_->SetBranchAddress("dtRechitCluster_match_gLLP_dau1_e",             &dtRechitCluster_match_gLLP_dau1_e);
  tree_->SetBranchAddress("dtRechitCluster_match_gLLP_dau2_e",             &dtRechitCluster_match_gLLP_dau2_e);
  ...
  tree_->SetBranchAddress("cscRechitCluster_match_gLLP_dau1",             &cscRechitCluster_match_gLLP_dau1);
  tree_->SetBranchAddress("cscRechitCluster_match_gLLP_dau2",             &cscRechitCluster_match_gLLP_dau2);
  tree_->SetBranchAddress("cscRechitCluster_match_gLLP_dau1_e",             &cscRechitCluster_match_gLLP_dau1_e);
  tree_->SetBranchAddress("cscRechitCluster_match_gLLP_dau2_e",             &cscRechitCluster_match_gLLP_dau2_e);
  ...
  //daug
  tree_->SetBranchAddress("nGLLPDau", &nGLLPDau);
  tree_->SetBranchAddress("gLLP_daughter_id", gLLP_daughter_id);
  tree_->SetBranchAddress("gLLP_daughter_prod_vertex_x", gLLP_daughter_prod_vertex_x);
  tree_->SetBranchAddress("gLLP_daughter_prod_vertex_y", gLLP_daughter_prod_vertex_y);
  tree_->SetBranchAddress("gLLP_daughter_prod_vertex_z", gLLP_daughter_prod_vertex_z);
  tree_->SetBranchAddress("gLLP_daughter_decay_vertex_x", gLLP_daughter_decay_vertex_x);
  tree_->SetBranchAddress("gLLP_daughter_decay_vertex_y", gLLP_daughter_decay_vertex_y);
  tree_->SetBranchAddress("gLLP_daughter_decay_vertex_z", gLLP_daughter_decay_vertex_z);
  tree_->SetBranchAddress("gLLP_daughter_px", gLLP_daughter_px);
  tree_->SetBranchAddress("gLLP_daughter_py", gLLP_daughter_py);
  tree_->SetBranchAddress("gLLP_daughter_pz", gLLP_daughter_pz);
...
void TreeMuonSystemSUEP::LoadTree(const char* file)
{
  f_ = TFile::Open(file);
  assert(f_);
...
void TreeMuonSystemSUEP::CreateTree()
{
  ...
  tree_->Branch("T",      &T,     "T/I");      // event number
  ...
  tree_->Branch("nDtRings",             &nDtRings, "nDtRings/I");
    ...
    tree_->Branch("cscRechitCluster_match_gLLP_dau1",             cscRechitCluster_match_gLLP_dau1, "cscRechitCluster_match_gLLP_dau1[nCscRechitClusters]/O");
    tree_->Branch("cscRechitCluster_match_gLLP_dau2",             cscRechitCluster_match_gLLP_dau2, "cscRechitCluster_match_gLLP_dau2[nCscRechitClusters]/O");
    tree_->Branch("cscRechitCluster_match_gLLP_dau1_e",             cscRechitCluster_match_gLLP_dau1_e, "cscRechitCluster_match_gLLP_dau1_e[nCscRechitClusters]/F");
    tree_->Branch("cscRechitCluster_match_gLLP_dau2_e",             cscRechitCluster_match_gLLP_dau2_e, "cscRechitCluster_match_gLLP_dau2_e[nCscRechitClusters]/F");
    ...
    tree_->Branch("dtRechitClusterNOppositeSegStation4",             dtRechitClusterNOppositeSegStation4,             "dtRechitClusterNOppositeSegStation4[nDtRechitClusters]/I");
        ...
        tree_->Branch("dtRechitCluster_match_gLLP_dau1",             dtRechitCluster_match_gLLP_dau1, "dtRechitCluster_match_gLLP_dau1[nDtRechitClusters]/O");
        tree_->Branch("dtRechitCluster_match_gLLP_dau2",             dtRechitCluster_match_gLLP_dau2, "dtRechitCluster_match_gLLP_dau2[nDtRechitClusters]/O");
        tree_->Branch("dtRechitCluster_match_gLLP_dau1_e",             dtRechitCluster_match_gLLP_dau1_e, "dtRechitCluster_match_gLLP_dau1_e[nDtRechitClusters]/F");
        tree_->Branch("dtRechitCluster_match_gLLP_dau2_e",             dtRechitCluster_match_gLLP_dau2_e, "dtRechitCluster_match_gLLP_dau2_e[nDtRechitClusters]/F");
  ...
  //daughters
  tree_->Branch("nGLLPDau", &nGLLPDau, "nGLLPDau/I");
  tree_->Branch("gLLP_daughter_id", gLLP_daughter_id, "gLLP_daughter_id[nGLLPDau]/I");
  tree_->Branch("gLLP_daughter_prod_vertex_x", gLLP_daughter_prod_vertex_x, "gLLP_daughter_prod_vertex_x[nGLLPDau]/F");
  tree_->Branch("gLLP_daughter_prod_vertex_y", gLLP_daughter_prod_vertex_y, "gLLP_daughter_prod_vertex_y[nGLLPDau]/F");
  tree_->Branch("gLLP_daughter_prod_vertex_z", gLLP_daughter_prod_vertex_z, "gLLP_daughter_prod_vertex_z[nGLLPDau]/F");
  tree_->Branch("gLLP_daughter_decay_vertex_x", gLLP_daughter_decay_vertex_x, "gLLP_daughter_decay_vertex_x[nGLLPDau]/F");
  tree_->Branch("gLLP_daughter_decay_vertex_y", gLLP_daughter_decay_vertex_y, "gLLP_daughter_decay_vertex_y[nGLLPDau]/F");
  tree_->Branch("gLLP_daughter_decay_vertex_z", gLLP_daughter_decay_vertex_z, "gLLP_daughter_decay_vertex_z[nGLLPDau]/F");
  tree_->Branch("gLLP_daughter_px", gLLP_daughter_px, "gLLP_daughter_px[nGLLPDau]/F");
  tree_->Branch("gLLP_daughter_py", gLLP_daughter_py, "gLLP_daughter_py[nGLLPDau]/F");
  tree_->Branch("gLLP_daughter_pz", gLLP_daughter_pz, "gLLP_daughter_pz[nGLLPDau]/F");
  tree_->Branch("gLLP_daughter_pt", gLLP_daughter_pt, "gLLP_daughter_pt[nGLLPDau]/F");
  tree_->Branch("gLLP_daughter_eta", gLLP_daughter_eta, "gLLP_daughter_eta[nGLLPDau]/F");
  tree_->Branch("gLLP_daughter_phi", gLLP_daughter_phi, "gLLP_daughter_phi[nGLLPDau]/F");
  tree_->Branch("gLLP_daughter_eta_ecalcorr", gLLP_daughter_eta_ecalcorr, "gLLP_daughter_eta_ecalcorr[nGLLPDau]/F");
  tree_->Branch("gLLP_daughter_phi_ecalcorr", gLLP_daughter_phi_ecalcorr, "gLLP_daughter_phi_ecalcorr[nGLLPDau]/F");
  tree_->Branch("gLLP_daughter_e", gLLP_daughter_e, "gLLP_daughter_e[nGLLPDau]/F");
  tree_->Branch("gLLP_daughter_mass", gLLP_daughter_mass, "gLLP_daughter_mass[nGLLPDau]/F");
