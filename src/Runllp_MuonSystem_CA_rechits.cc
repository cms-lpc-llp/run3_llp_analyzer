...
void usage()
{
  std::cerr << "Usage: Runllp_MuonSystem_CA_rechits  <input list>  [options]\n[options]:\n"
	    << "-d  --isData\n"
...
int main(int argc, char* argv[]){
  ...
  std::cout << "[INFO]: optionalLabel --> " << label << std::endl;
    ...
    llp_MuonSystem_CA_rechits analyzer(theChain);

    //------ EXECUTE ------//
    cout << "Executing llp_MuonSystem_CA_rechits..." << endl;
    analyzer.EnableAll();
