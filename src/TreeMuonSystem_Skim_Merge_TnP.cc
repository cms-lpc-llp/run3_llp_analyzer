...
// Constructor
TreeMuonSystem_Skim_Merge_TnP::TreeMuonSystem_Skim_Merge_TnP()
{
  InitVariables();
};
TreeMuonSystem_Skim_Merge_TnP::~TreeMuonSystem_Skim_Merge_TnP()
...
void TreeMuonSystem_Skim_Merge_TnP::InitVariables()
{
  runNum=0; lumiSec=0; evtNum=0; MC_condition = 0; category=0;
  npv=0; npu=0;
  pileupWeight = 0;
  ...
  HTSoftJetsLargerThan3p139 = 0.;
  nSoftJets2p65to3p139 = 0;
  nSoftJetsLargerThan2p65 = 0;
  nSoftJetsLargerThan3p139 = 0;

  HTSoftJets2p65to3p139AllJets = 0.;
  HTSoftJetsLargerThan2p65AllJets = 0.;
  HTSoftJetsLargerThan3p139AllJets = 0.;
  nSoftJets2p65to3p139AllJets = 0;
  nSoftJetsLargerThan2p65AllJets = 0;
  nSoftJetsLargerThan3p139AllJets = 0;
...
void TreeMuonSystem_Skim_Merge_TnP::InitTree()
{
  ...
  tree_->SetBranchAddress("numTag",      &numTag);
  ...
  tree_->SetBranchAddress("nSoftJetsLargerThan3p139",      &nSoftJetsLargerThan3p139);
  ...
  tree_->SetBranchAddress("HTSoftJetsLargerThan3p139",      &HTSoftJetsLargerThan3p139);
  //branches added to check soft forward activity
  tree_->SetBranchAddress("nSoftJets2p65to3p139AllJets",      &nSoftJets2p65to3p139AllJets);
  tree_->SetBranchAddress("nSoftJetsLargerThan2p65AllJets",      &nSoftJetsLargerThan2p65AllJets);
  tree_->SetBranchAddress("nSoftJetsLargerThan3p139AllJets",      &nSoftJetsLargerThan3p139AllJets);
  tree_->SetBranchAddress("HTSoftJets2p65to3p139AllJets",      &HTSoftJets2p65to3p139AllJets);
  tree_->SetBranchAddress("HTSoftJetsLargerThan2p65AllJets",      &HTSoftJetsLargerThan2p65AllJets);
  tree_->SetBranchAddress("HTSoftJetsLargerThan3p139AllJets",      &HTSoftJetsLargerThan3p139AllJets);
  ...
  tree_->SetBranchAddress("cscRechitCluster_matchToMuon1",             cscRechitCluster_matchToMuon1);
  tree_->SetBranchAddress("cscRechitCluster_matchToMuon2",             cscRechitCluster_matchToMuon2);
  tree_->SetBranchAddress("cscRechitCluster_matchToNotProbeMuon",             cscRechitCluster_matchToNotProbeMuon);
  tree_->SetBranchAddress("cscRechitCluster_matchToProbeAndJet",             cscRechitCluster_matchToProbeAndJet);
  tree_->SetBranchAddress("cscRechitCluster_matchToHighPtJet",             cscRechitCluster_matchToHighPtJet);
  tree_->SetBranchAddress("cscRechitCluster_matchToLowPtJet",             cscRechitCluster_matchToLowPtJet);
...
void TreeMuonSystem_Skim_Merge_TnP::CreateTree()
{
  ...
  tree_->Branch("numTag",      &numTag,     "numTag/I");
  ...
  tree_->Branch("nDtRings",             &nDtRings, "nDtRings/I");
    ...
    tree_->Branch("cscRechitCluster_matchToMuon1",             cscRechitCluster_matchToMuon1,            "cscRechitCluster_matchToMuon1[nCscRechitClusters]/O");
    tree_->Branch("cscRechitCluster_matchToMuon2",             cscRechitCluster_matchToMuon2,            "cscRechitCluster_matchToMuon2[nCscRechitClusters]/O");
    tree_->Branch("cscRechitCluster_matchToProbeAndJet",             cscRechitCluster_matchToProbeAndJet,            "cscRechitCluster_matchToProbeAndJet[nCscRechitClusters]/O");
    ...
    tree_->Branch("cscRechitCluster_matchToHighPtJet",             cscRechitCluster_matchToHighPtJet,            "cscRechitCluster_matchToHighPtJet[nCscRechitClusters]/O");
    tree_->Branch("cscRechitCluster_matchToLowPtJet",             cscRechitCluster_matchToLowPtJet,            "cscRechitCluster_matchToLowPtJet[nCscRechitClusters]/O");
  ...
  tree_->Branch("nSoftJetsLargerThan3p139", &nSoftJetsLargerThan3p139, "nSoftJetsLargerThan3p139/I");
  ...
  tree_->Branch("HTSoftJetsLargerThan3p139", &HTSoftJetsLargerThan3p139, "HTSoftJetsLargerThan3p139/F");
  
  tree_->Branch("nSoftJets2p65to3p139AllJets", &nSoftJets2p65to3p139AllJets, "nSoftJets2p65to3p139AllJets/I");
  tree_->Branch("nSoftJetsLargerThan2p65AllJets", &nSoftJetsLargerThan2p65AllJets, "nSoftJetsLargerThan2p65AllJets/I");
  tree_->Branch("nSoftJetsLargerThan3p139AllJets", &nSoftJetsLargerThan3p139AllJets, "nSoftJetsLargerThan3p139AllJets/I");
  tree_->Branch("HTSoftJets2p65to3p139AllJets", &HTSoftJets2p65to3p139AllJets, "HTSoftJets2p65to3p139AllJets/F");
  tree_->Branch("HTSoftJetsLargerThan2p65AllJets", &HTSoftJetsLargerThan2p65AllJets, "HTSoftJetsLargerThan2p65AllJets/F");
  tree_->Branch("HTSoftJetsLargerThan3p139AllJets", &HTSoftJetsLargerThan3p139AllJets, "HTSoftJetsLargerThan3p139AllJets/F");
