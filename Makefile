...
UTILS =$(SRCDIR)/RazorHelper.cc  $(SRCDIR)/DBSCAN.cc  $(SRCDIR)/CACluster.cc ${SRCDIR}/TreeMuonSystemCombination.cc ${SRCDIR}/TreeMuonSystemCombination_TnP.cc ${SRCDIR}/TreeMuonSystemSUEP.cc
UTILSOBJ = $(UTILS:cc=o)
EXECUTABLES = MergeNtuples NormalizeNtuple NormalizeNtupleSUEP SkimNtuple $(RUNNERS)
#EXECUTABLES = $(RUNNERS)
...
$(SRCDIR)/SUEP_event.o: $(SRCDIR)/SUEP_event.C $(INCLUDEDIR)/SUEP_event.h
	$(CXX) $(SRCDIR)/SUEP_event.C $(CXXFLAGS) -I$(INCLUDEDIR) -c $(LDFLAGS) $(LIBS) -o $@ $(CXX14FLAGS)
...
$(SRCDIR)/RazorAnalyzerSUEP.o: $(SRCDIR)/SUEP_event.o $(SRCDIR)/RazorAnalyzerSUEP.cc
	$(CXX) $(SRCDIR)/RazorAnalyzerSUEP.cc $(CXXFLAGS) -I$(INCLUDEDIR) -c $(LDFLAGS) $(LIBS) -o $@ $(CXX14FLAGS)
...
$(RUNNERS): $(BINDIR)/Run%: $(SRCDIR)/SUEP_event.o $(SRCDIR)/RazorAnalyzerSUEP.o $(UTILSOBJ) $(ANADIR)/%.o $(SRCDIR)/Run%.cc
	$(CXX) $^ $(CXXFLAGS) -I$(INCLUDEDIR) -I$(ANADIR) $(LDFLAGS) $(LIBS) -o $@ $(CXX14FLAGS)
...
NormalizeNtupleSUEP: $(SRCDIR)/SimpleTable.o $(SRCDIR)/NormalizeNtupleSUEP.cc $(INCLUDEDIR)/rootdict.o
	$(CXX) $^ $(CXXFLAGS) -I$(INCLUDEDIR) $(LDFLAGS) $(LIBS) -o $@ $(CXX14FLAGS)
