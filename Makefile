...
MDSNANO_UTILS = $(SRCDIR)/RazorHelper.cc $(SRCDIR)/JetCorrectorParameters.cc \
		$(SRCDIR)/SimpleJetCorrectionUncertainty.cc $(SRCDIR)/JetCorrectionUncertainty.cc \
	       	$(SRCDIR)/CACluster.cc $(SRCDIR)/TreeMuonSystemCombination.cc
MDSNANO_UTILSOBJ = $(MDSNANO_UTILS:cc=o)
EXECUTABLES = $(RUNNERS)
