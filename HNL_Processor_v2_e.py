...
class HNL_Processor_v2_e(processor.ProcessorABC):
    ...
    def electronSelections(self, electrons, mask_to_exclude=None, invertElectronId=False, cut_based_ID=True):
        if cut_based_ID:
    ...
    ###     PROCESSOR   ####
    ########################
    def process(self, events, hists_to_process: list=None, fillGenHists = True, fromTau = False, branchNames_for_invertElectronID = ["CSC_Cluster_Size"], cut_based_ID=True):
        ...
        electron_mask = self.electronSelections(electrons, cut_based_ID=cut_based_ID)
