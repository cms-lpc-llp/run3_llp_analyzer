...
python3 scripts_condor/submit_normalize_LPC.py HNL_tau_mN_1_ctau_100 $1 tau-HNL_mN_1_100_ctau_$1 $2

echo "Submitting jobs tau-HNL signal, ctau 100 mN 3"
python3 scripts_condor/submit_normalize_LPC.py HNL_tau_mN_3_ctau_100 $1 tau-HNL_mN_3_100_ctau_$1 $2
...
echo "Submitting jobs tau-HNL signal, ctau 1000 mN 1"
python3 scripts_condor/submit_normalize_LPC.py HNL_tau_mN_1_ctau_1000 $1 tau-HNL_1000_1_$1 $2

echo "Submitting jobs tau-HNL signal, ctau 1000 mN 3"
python3 scripts_condor/submit_normalize_LPC.py HNL_tau_mN_3_ctau_1000 mdsnano_hnl $1 tau-HNL_1000_3_$1 $2
