...
then
	...
	echo "${CMSSW_BASE}/src/run3_llp_analyzer/python/printJson.py"
	if [ -f ${CMSSW_BASE}/src/run3_llp_analyzer/python/printJson.py ]
	then
		cp $CMSSW_BASE/src/run3_llp_analyzer/python/printJson.py ./
		#get grid proxy
