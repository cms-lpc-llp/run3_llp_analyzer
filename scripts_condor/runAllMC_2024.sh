...
python3 scripts_condor/submit_condor_LPC.py HNL_tau_mN_2_ctau_1000 mdsnano_hnl 3 $1 tau-HNL_$1 2 4096
...
python3 scripts_condor/submit_condor_LPC.py HNL_tau_mN_1_ctau_1000 mdsnano_hnl 3 $1 tau-HNL_$1 2 4096

echo "Submitting jobs tau-HNL signal, ctau 1000 mN 3"
python3 scripts_condor/submit_condor_LPC.py HNL_tau_mN_3_ctau_1000 mdsnano_hnl 3 $1 tau-HNL_$1 2 4096
